...
def eda_analysis(file_path):
    ...
    for col in df.select_dtypes(include=['number']).columns:
        ...
        # This code will helps you how to apply fill missing values for all attributes at once 
        # in previous class we check independant variables and try to fill missing values based on the indexes.
        # But this gives you to fill missing values at one shot for whole dataset
    ...
    # why convert is null to string, because LLM is string model or not thats why
...
# Note if app.py doesnot run the code or shows any error use >python app(19-12).py
